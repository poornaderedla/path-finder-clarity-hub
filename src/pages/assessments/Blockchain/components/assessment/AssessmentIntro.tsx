...
const AssessmentIntro = ({ onStart }: AssessmentIntroProps) => {
  const careers = [
    { title: 'Blockchain Developer', description: 'Build core blockchain systems' },
    { title: 'Smart Contract Engineer', description: 'Write and audit Ethereum contracts' },
    { title: 'Web3 App Developer', description: 'Front-end + smart contracts' },
    { title: 'Crypto Analyst', description: 'Analyze markets and tokens' },
    { title: 'Blockchain Product Manager', description: 'Drive features in DApp teams' }
  ];
      ...
      <Card className="border-2 border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50">
        <CardHeader className="text-center pb-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            and career alignment for a future in blockchain development and Web3 innovation.
          </p>
        </CardHeader>
        ...
        <CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">Decentralization</h4>
              <p className="text-sm text-blue-700">Distributed across network nodes</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-green-900 mb-2">Smart Contracts</h4>
              <p className="text-sm text-green-700">Self-executing digital contracts</p>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg">
              <h4 className="font-semibold text-purple-900 mb-2">Digital Assets</h4>
              <p className="text-sm text-purple-700">Cryptocurrencies, NFTs, tokens</p>
            </div>
          </div>
        </CardContent>
      </Card>
