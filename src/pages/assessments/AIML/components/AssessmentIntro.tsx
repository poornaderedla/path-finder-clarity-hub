...
const AssessmentIntro = ({ onNext }: AssessmentIntroProps) => {
  const careers = [
    { title: 'Machine Learning Engineer', description: 'Build and deploy ML models' },
    { title: 'Data Scientist', description: 'Analyze and interpret complex data' },
    { title: 'AI Product Manager', description: 'Bridge AI tech and business needs' },
    { title: 'ML Ops Engineer', description: 'Operationalize ML pipelines' },
    { title: 'AI Research Assistant', description: 'Support research in AI/ML' }
  ];
  ...
  const traits = [
    ...
    'Comfort with scripting/programming',
    'Attention to detail'
  ];
      ...
      <Card className="border-2 border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50">
        <CardHeader className="text-center pb-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            and career alignment for a future in AI/ML development and research.
          </p>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>What is AI/ML?</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-gray-700 text-lg leading-relaxed mb-4">
            Artificial Intelligence (AI) and Machine Learning (ML) are rapidly growing fields that focus on building systems that can learn from data, make predictions, and automate complex tasks. They are transforming industries and creating new career opportunities.
          </p>
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">AI/ML Platforms</h4>
