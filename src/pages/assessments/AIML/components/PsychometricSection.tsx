...
const questions = [
  {
    category: 'Interest',
    question: 'I am excited about building systems that can learn from data.',
    options: [
  ...
  {
    category: 'Interest',
    question: 'I follow the latest developments in AI/ML models and tools.',
    options: [
      { value: '5', label: 'Strongly Agree' },
      { value: '4', label: 'Agree' },
      { value: '3', label: 'Neutral' },
  ...
  {
    category: 'Personality',
    question: 'I am comfortable working with ambiguous or incomplete information.',
    options: [
      { value: '5', label: 'Strongly Agree' },
      { value: '4', label: 'Agree' },
      { value: '3', label: 'Neutral' },
...
const PsychometricSection = ({ onComplete }: PsychometricSectionProps) => {
  ...
  const calculateScores = () => {
    const categories = ['Interest', 'Personality', 'Mindset'];
