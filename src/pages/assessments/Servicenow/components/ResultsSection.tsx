...
const ResultsSection = ({ assessmentData }: ResultsSectionProps) => {
  ...
  const calculateOverallRecommendation = () => {
    ...
    if (overallScore >= 75) {
      return {
        recommendation: 'YES',
        title: 'ServiceNow is an Excellent Fit for You!',
        color: 'green',
        icon: CheckCircle,
      ...
      return {
        ...
        title: 'ServiceNow Could Be Right with Preparation',
        color: 'orange',
        icon: AlertTriangle,
        description: 'You have potential but may need to strengthen certain areas before diving deep into ServiceNow.'
      };
    } else {
      return {
        recommendation: 'NO',
  ...
  const careerPaths = [
    {
      ...
      requirements: ['JavaScript', 'ServiceNow Platform', 'Business Logic']
    },
    {
    ...
    },
    {
      ...
      description: 'Design enterprise workflow solutions',
      skillMatch: Math.max(wiscar?.dimensions?.['Real-World Alignment'] || 0, 70),
      requirements: ['ITIL Knowledge', 'Process Design', 'Client Consulting']
    },
    {
  ...
  const learningPath = [
    {
      stage: 'Foundation',
      modules: ['ServiceNow Basics', 'Platform Navigation', 'ITSM Fundamentals'],
      duration: '2-4 weeks',
      completed: false
    },
    {
      stage: 'Intermediate',
      modules: ['Scripting Basics', 'Workflow Design', 'Form Configuration'],
      duration: '6-8 weeks',
      completed: false
    },
    {
      stage: 'Advanced',
      modules: ['Custom Applications', 'Integration', 'Performance Optimization'],
      duration: '8-12 weeks',
      completed: false
    },
    {
      stage: 'Certification',
      modules: ['CSA Prep', 'Practice Projects', 'Portfolio Building'],
      duration: '4-6 weeks',
      completed: false
    }
  ];
  ...
  const alternatives = [
    { title: 'Power Platform (Microsoft)', reason: 'Similar workflow focus, more visual' },
