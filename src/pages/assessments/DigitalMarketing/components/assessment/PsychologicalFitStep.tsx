...
interface PsychologicalFitStepProps {
  onComplete: (data: any) => void;
}

const PsychologicalFitStep = ({ onComplete }: PsychologicalFitStepProps) => {
  ...
  const questions = [
    ...
    },
    {
      ...
      question: 'I believe I can develop strong digital marketing skills with practice and learning',
      options: [
        { value: '5', label: 'Strongly Agree' },
        { value: '4', label: 'Agree' },
        { value: '3', label: 'Neutral' },
    ...
    {
      category: 'Growth Mindset',
      question: 'I enjoy staying updated with the latest marketing trends and technologies',
      options: [
        { value: '5', label: 'Strongly Agree' },
        { value: '4', label: 'Agree' },
        { value: '3', label: 'Neutral' },
...
export default PsychologicalFitStep;
