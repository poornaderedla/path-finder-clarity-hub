...
const ResultsSection = ({ assessmentData }: ResultsSectionProps) => {
  ...
  const calculateOverallRecommendation = () => {
    ...
    if (overallScore >= 75) {
      return {
        recommendation: 'YES',
        title: 'Digital Marketing is an Excellent Fit for You!',
        color: 'green',
        icon: CheckCircle,
      ...
      return {
        ...
        title: 'Digital Marketing Could Be Right with Preparation',
        color: 'orange',
        icon: AlertTriangle,
        description: 'You have potential but may need to strengthen certain areas before diving deep into digital marketing.'
      };
    } else {
      return {
        recommendation: 'NO',
  ...
  const careerPaths = [
    {
      ...
      description: 'Manage comprehensive online campaigns',
      skillMatch: Math.max(technical?.categories?.['Technical Skills'] || 0, 70),
      requirements: ['Google Analytics', 'Social Media', 'Content Creation']
    },
    {
      title: 'SEO Specialist',
      description: 'Optimize websites for search engines',
      skillMatch: Math.max(technical?.categories?.['Technical Skills'] || 0, 75),
      requirements: ['SEO Tools', 'Keyword Research', 'Technical SEO']
    },
    {
      ...
      requirements: ['Platform Management', 'Content Strategy', 'Community Engagement']
    },
    {
      title: 'PPC Specialist',
      description: 'Manage paid advertising campaigns',
      skillMatch: Math.max(technical?.categories?.['Technical Skills'] || 0, 65),
      requirements: ['Google Ads', 'Facebook Ads', 'Campaign Optimization']
    }
  ];
  ...
  const learningPath = [
    {
      stage: 'Foundation',
      modules: ['Digital Marketing Basics', 'Google Analytics', 'Social Media Fundamentals'],
      duration: '2-4 weeks',
      completed: false
    },
    {
      stage: 'Intermediate',
      modules: ['SEO Techniques', 'PPC Campaigns', 'Content Marketing'],
      duration: '4-6 weeks',
      completed: false
    },
    {
      stage: 'Advanced',
      modules: ['Marketing Automation', 'Advanced Analytics', 'Strategy Development'],
      duration: '6-8 weeks',
      completed: false
    },
    {
      stage: 'Certification',
      modules: ['Google Ads Certification', 'Google Analytics Certification', 'Portfolio Building'],
      duration: '4-6 weeks',
      completed: false
    }
  ];
  ...
  const alternatives = [
    { title: 'Content Marketing', reason: 'Focus on creative content creation and storytelling' },
    { title: 'Data Analytics', reason: 'Leverage analytical skills for business intelligence' },
    { title: 'Social Media Management', reason: 'Creative engagement without heavy technical requirements' },
    { title: 'Brand Management', reason: 'Strategic brand development and positioning' }
  ];
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-1 text-sm text-blue-800">
                <li>• Join Digital Marketing communities and forums</li>
                <li>• Sign up for Google Analytics and Google Ads (free)</li>
                <li>• Start with "Digital Marketing Fundamentals" course</li>
                <li>• Practice with personal projects and case studies</li>
              </ul>
            </div>
          </CardContent>
        </Card>
