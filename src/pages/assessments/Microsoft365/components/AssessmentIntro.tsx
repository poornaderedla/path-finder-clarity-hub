...
const AssessmentIntro = ({ onNext }: AssessmentIntroProps) => {
  const careers = [
    { title: 'Dynamics 365 Developer', description: 'Build custom solutions and integrations' },
    { title: 'Dynamics 365 Administrator', description: 'Manage platform and users' },
    { title: 'Functional Consultant', description: 'Configure solutions and optimize processes' },
    { title: 'Solution Architect', description: 'Design enterprise system architecture' },
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>What is Microsoft Dynamics 365?</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-gray-700 text-lg leading-relaxed mb-4">
            Microsoft Dynamics 365 is a powerful <strong>cloud-based platform</strong> that specializes in 
            <strong> Enterprise Resource Planning (ERP)</strong> and Customer Relationship Management (CRM). 
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-green-900 mb-2">Business Integration</h4>
        ...
        <CardContent>
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div>
              ...
              <p className="text-sm text-blue-700">Understand if Dynamics 365 aligns with your career goals</p>
            </div>
            <div>
