...
const ResultsSection = ({ assessmentData }: ResultsSectionProps) => {
  ...
  const calculateOverallRecommendation = () => {
    ...
    if (overallScore >= 75) {
      return {
        recommendation: 'YES',
        title: 'Microsoft Dynamics 365 is an Excellent Fit for You!',
        color: 'green',
        icon: CheckCircle,
      ...
      return {
        ...
        title: 'Microsoft Dynamics 365 Could Be Right with Preparation',
        color: 'orange',
        icon: AlertTriangle,
        description: 'You have potential but may need to strengthen certain areas before diving deep into Dynamics 365.'
      };
    } else {
      return {
        recommendation: 'NO',
  ...
  const careerPaths = [
    {
      ...
      description: 'Build custom applications and integrations',
      skillMatch: Math.max(technical?.categories?.['Programming Fundamentals'] || 0, 70),
      requirements: ['C#', 'JavaScript', 'Dynamics 365 Platform', 'Business Logic']
    },
    {
      title: 'Dynamics 365 Administrator',
      description: 'Manage platform configuration and users',
      skillMatch: Math.max(technical?.categories?.['Database Concepts'] || 0, 75),
      requirements: ['Platform Admin', 'User Management', 'System Config']
    },
    {
      title: 'Functional Consultant',
      description: 'Configure and optimize business processes',
      skillMatch: Math.max(wiscar?.categories?.['Work Style'] || 0, 70),
      requirements: ['Business Analysis', 'Process Design', 'Client Consulting']
    },
    {
      title: 'Solution Architect',
      description: 'Design enterprise system architecture',
      skillMatch: Math.max(psychometric?.categories?.['Cognitive Style'] || 0, 65),
      requirements: ['System Design', 'Integration', 'Architecture Planning']
    }
  ];
  ...
  const learningPath = [
    {
      stage: 'Foundation',
      modules: ['Dynamics 365 Basics', 'Platform Navigation', 'Business Processes'],
      duration: '2-4 weeks',
      completed: false
    },
    {
      stage: 'Intermediate',
      modules: ['Power Platform', 'Workflow Design', 'Form Configuration'],
      duration: '6-8 weeks',
      completed: false
    },
    {
      stage: 'Advanced',
      modules: ['Custom Development', 'Integration', 'Performance Optimization'],
      duration: '8-12 weeks',
      completed: false
    },
    {
      stage: 'Certification',
      modules: ['MB-900 Prep', 'Practice Projects', 'Portfolio Building'],
      duration: '4-6 weeks',
      completed: false
    }
  ];
  ...
  const alternatives = [
    { title: 'Power Platform (Microsoft)', reason: 'Similar workflow focus, more visual development' },
    { title: 'Salesforce Administration', reason: 'CRM focus with automation features' },
    { title: 'Business Analysis', reason: 'Process improvement without heavy coding' },
    { title: 'IT Project Management', reason: 'Technology leadership and coordination' }
  ];
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-1 text-sm text-blue-800">
                <li>• Join the Microsoft Dynamics 365 Community</li>
                <li>• Sign up for a Dynamics 365 trial environment (free)</li>
                <li>• Start with "Dynamics 365 Fundamentals" course</li>
