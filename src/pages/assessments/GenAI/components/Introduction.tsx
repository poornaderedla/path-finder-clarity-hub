...
export const Introduction = ({ onStart }: IntroductionProps) => {
  const careers = [
    { title: 'Prompt Engineer', description: 'Craft effective inputs for AI models' },
    { title: 'AI Research Engineer', description: 'Build custom AI applications' },
    { title: 'GenAI Product Manager', description: 'Guide AI product strategy' },
    { title: 'ML Scientist', description: 'Develop new algorithms' },
    { title: 'Creative AI Developer', description: 'Build artistic AI tools' }
  ];
      ...
      <Card className="border-2 border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50">
        <CardHeader className="text-center pb-4">
          <CardTitle className="text-3xl font-bold text-gray-900 mb-2">
            Discover Your Generative AI Career Potential
          </CardTitle>
        ...
        <CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">Content Generation</h4>
              <p className="text-sm text-blue-700">Create text, images, and code</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-green-900 mb-2">Transformer Models</h4>
              <p className="text-sm text-green-700">Advanced neural architectures</p>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg">
              <h4 className="font-semibold text-purple-900 mb-2">Creative Computing</h4>
              <p className="text-sm text-purple-700">Blend art with technology</p>
            </div>
          </div>
        </CardContent>
      </Card>
