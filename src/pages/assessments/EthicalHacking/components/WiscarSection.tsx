  ...
  const questions = [
    {
      ...
      question: 'When I start learning something new in cybersecurity, I stick with it even when it gets difficult.',
      options: [
    ...
    {
      category: 'Will (Perseverance)',
      question: 'I have completed online cybersecurity courses or certifications in the past.',
      options: [
    ...
    },
    {
      ...
      question: 'I actively seek out information about cyber threats and defense tools.',
      options: [
    ...
    {
      category: 'Interest (Long-term)',
      question: 'I would enjoy learning about cybersecurity even if it wasn\'t for career reasons.',
      options: [
    ...
    },
    {
      ...
      question: 'How would you rate your current technical skills in cybersecurity?',
      options: [
        { value: '5', label: 'Advanced (Scripting, network analysis, etc.)' },
        { value: '4', label: 'Intermediate (Some hands-on experience)' },
        { value: '3', label: 'Basic (General IT knowledge)' },
    ...
    {
      category: 'Skill (Current Level)',
      question: 'Have you worked with security tools or participated in CTFs (Capture The Flag)?',
      options: [
        { value: '5', label: 'Extensively (Led projects/competitions)' },
        { value: '4', label: 'Moderately (Participated in several)' },
    ...
    },
    {
      ...
      question: 'I can understand complex relationships between different security controls and threats.',
      options: [
    ...
    {
      category: 'Cognitive Readiness',
      question: 'When faced with a complex security problem, I can break it down into smaller parts.',
      options: [
    ...
    },
    {
      ...
      question: 'I believe I can master new security tools and concepts with dedicated effort.',
      options: [
    ...
    {
      category: 'Ability to Learn',
      question: 'I actively seek feedback and use it to improve my cybersecurity skills.',
      options: [
        { value: '5', label: 'Always' },
        { value: '4', label: 'Usually' },
        { value: '3', label: 'Sometimes' },
    ...
    },
    {
      ...
      question: 'I would enjoy helping organizations secure their digital assets.',
      options: [
    ...
    {
      category: 'Real-World Alignment',
      question: 'I can see myself working in cybersecurity or digital forensics roles.',
      options: [
