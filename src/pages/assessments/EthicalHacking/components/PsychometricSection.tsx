...
const PsychometricSection = ({ onComplete }: PsychometricSectionProps) => {
  ...
  const questions = [
    {
      category: 'Interest',
      question: 'I am fascinated by how cyber attacks work and how to prevent them.',
      options: [
    ...
    },
    {
      ...
      question: 'I enjoy solving complex puzzles and problems.',
      options: [
        { value: '5', label: 'Strongly Agree' },
        { value: '4', label: 'Agree' },
        { value: '3', label: 'Neutral' },
    ...
    {
      category: 'Motivation',
      question: 'I am motivated by the challenge of defending systems from attackers.',
      options: [
        { value: '5', label: 'Strongly Agree' },
        { value: '4', label: 'Agree' },
        { value: '3', label: 'Neutral' },
    ...
    },
    {
      ...
      question: 'I believe I can improve my cybersecurity skills with effort and practice.',
      options: [
        { value: '5', label: 'Strongly Agree' },
        { value: '4', label: 'Agree' },
        { value: '3', label: 'Neutral' },
    ...
    {
      category: 'Teamwork',
      question: 'I enjoy collaborating with others to solve security challenges.',
      options: [
        { value: '5', label: 'Strongly Agree' },
        { value: '4', label: 'Agree' },
        { value: '3', label: 'Neutral' },
