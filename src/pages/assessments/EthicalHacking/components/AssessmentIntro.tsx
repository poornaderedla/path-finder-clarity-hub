...
const AssessmentIntro = ({ onNext }: AssessmentIntroProps) => {
  const careers = [
    { title: 'Cybersecurity Analyst', description: 'Monitor and defend systems' },
    { title: 'Penetration Tester', description: 'Test security by simulating attacks' },
    { title: 'Security Engineer', description: 'Design and implement secure systems' },
    { title: 'Incident Responder', description: 'React to and investigate breaches' },
    { title: 'GRC Specialist', description: 'Governance, Risk, and Compliance roles' }
  ];
      ...
      <Card className="border-2 border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50">
        <CardHeader className="text-center pb-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            and career alignment for a future in cybersecurity and digital defense.
          </p>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-gray-700 text-lg leading-relaxed mb-4">
            ...
            It is essential for safeguarding sensitive information and ensuring the integrity, confidentiality, and availability of data in our increasingly connected world.
          </p>
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">Threat Defense</h4>
              <p className="text-sm text-blue-700">Prevent, detect, and respond to cyber threats</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-green-900 mb-2">Risk Management</h4>
              <p className="text-sm text-green-700">Identify and mitigate vulnerabilities</p>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg">
              <h4 className="font-semibold text-purple-900 mb-2">Digital Trust</h4>
              <p className="text-sm text-purple-700">Build trust in digital systems and services</p>
            </div>
          </div>
        </CardContent>
      </Card>
