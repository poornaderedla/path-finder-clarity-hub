...
const WiscarSection = ({ onComplete }: WiscarSectionProps) => {
  ...
  const questions = [
    ...
    },
    {
      ...
      question: 'I actively seek out information about cloud computing and distributed systems',
      options: [
    ...
    {
      category: 'Interest (Long-term)',
      question: 'I would enjoy learning about Google Cloud Platform even if it wasn\'t for career reasons',
      options: [
    ...
    {
      category: 'Skill (Current Level)',
      question: 'Have you worked with cloud technologies or infrastructure before?',
      options: [
        { value: '5', label: 'Extensively (Led cloud projects)' },
        { value: '4', label: 'Moderately (Participated in cloud projects)' },
    ...
    },
    {
      ...
      question: 'I can understand complex relationships between different cloud services and components',
      options: [
    ...
    },
    {
      ...
      question: 'I believe I can master new cloud engineering skills with dedicated effort',
      options: [
    ...
    },
    {
      ...
      question: 'I would enjoy helping organizations build and manage cloud infrastructure',
      options: [
    ...
    {
      category: 'Real-World Alignment',
      question: 'I can see myself working in cloud engineering or DevOps roles',
      options: [
