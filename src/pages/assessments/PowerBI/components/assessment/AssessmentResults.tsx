...
export const AssessmentResults = ({ assessmentData }: AssessmentResultsProps) => {
  ...
  const calculateOverallRecommendation = () => {
    ...
    if (overallScore >= 75) {
      return {
        recommendation: 'YES',
        title: 'Power BI & Tableau are an Excellent Fit for You!',
        color: 'green',
        icon: CheckCircle,
      ...
      return {
        ...
        title: 'Power BI & Tableau Could Be Right with Preparation',
        color: 'orange',
        icon: AlertTriangle,
        description: 'You have potential but may need to strengthen certain areas before diving deep into BI tools.'
      };
    } else {
      return {
        recommendation: 'NO',
  ...
  const careerPaths = [
    {
      ...
      description: 'Builds dashboards and extracts KPIs',
      skillMatch: Math.max(technical?.categories?.['Data Literacy'] || 0, 70),
      requirements: ['Data Analysis', 'Dashboard Design', 'KPI Development']
    },
    {
      title: 'Data Analyst',
      description: 'Analyzes trends and answers questions with data',
      skillMatch: Math.max(technical?.categories?.['Numerical Aptitude'] || 0, 75),
      requirements: ['Statistical Analysis', 'Data Interpretation', 'Report Creation']
    },
    {
      title: 'Data Visualization Specialist',
      description: 'Designs compelling dashboards and reports',
      skillMatch: Math.max(psychometric?.categories?.['Interest (RIASEC)'] || 0, 70),
      requirements: ['Visual Design', 'Chart Selection', 'User Experience']
    },
    {
      title: 'BI Developer',
      description: 'Develops and maintains BI solutions',
      skillMatch: Math.max(technical?.categories?.['BI Tool Concepts'] || 0, 65),
      requirements: ['Tool Mastery', 'Data Modeling', 'Performance Optimization']
    }
  ];
  ...
  const learningPath = [
    {
      stage: 'Foundation',
      modules: ['Power BI Desktop Basics', 'Tableau Fundamentals', 'Data Visualization Principles'],
      duration: '2-4 weeks',
      completed: false
    },
    {
      stage: 'Intermediate',
      modules: ['DAX Formulas', 'Calculated Fields', 'Data Blending'],
      duration: '6-8 weeks',
      completed: false
    },
    {
      stage: 'Advanced',
      modules: ['Advanced Dashboards', 'Performance Optimization', 'Enterprise Deployment'],
      duration: '8-12 weeks',
      completed: false
    },
    {
      stage: 'Certification',
      modules: ['DA-100 Prep', 'Tableau Desktop Specialist', 'Portfolio Building'],
      duration: '4-6 weeks',
      completed: false
    }
  ];
  ...
  const alternatives = [
    { title: 'Data Science', reason: 'More statistical and programming focused' },
    { title: 'Business Analysis', reason: 'Process improvement without heavy technical requirements' },
    { title: 'Project Management', reason: 'Technology leadership and coordination' },
    { title: 'Marketing Analytics', reason: 'Creative data analysis for marketing campaigns' }
  ];
        ...
        <Card className="border-orange-200">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {wiscar?.categories && Object.entries(wiscar.categories).map(([category, score]) => (
                  <div key={category} className="flex justify-between text-sm">
                    <span className="text-gray-600">{category}</span>
                    <span className="font-medium">{typeof score === 'number' ? score : 0}%</span>
                  </div>
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-1 text-sm text-blue-800">
                <li>• Join the Power BI and Tableau Community Forums</li>
                <li>• Sign up for free trials of Power BI and Tableau</li>
                <li>• Start with "Power BI Fundamentals" course on Microsoft Learn</li>
                <li>• Practice with public datasets and sample projects</li>
              </ul>
            </div>
          </CardContent>
        </Card>
